...
<nav class="white" role="navigation">
  <div class="nav-wrapper container">
    ...
    <ul class="right hide-on-med-and-down">
      <li>
        <a href="#" class='dropdown-button' data-activates='droplist'>
          <ul class="">
            <li>Welcome Student <strong><u><?php echo getAcctFullname(array($_SESSION['ACCT_NO'])); ?></u></strong></li>
    ...
    <ul id='droplist' class='dropdown-content black-text'>
      ...
      <li><a href="/practicumhub/home/manageclass">Manage Class</a></li>
      <li><a href="/practicumhub/home/managedtr">Manage DTR</a></li>
