...
<nav class="white" role="navigation">
  <div class="nav-wrapper container">
    ...
    <ul class="right hide-on-med-and-down">
      <li>
        <a href="#" class='dropdown-button' data-activates='droplist'>
          <ul class="">
            <li>Welcome Trainer <strong><u><?php echo getAcctFullname(array($_SESSION['ACCT_NO'])); ?></u></strong></li>
    ...
    <ul id='droplist' class='dropdown-content black-text'>
      ...
      <li><a href="/practicumhub/home/viewcompany">View Company</a></li>
      <li><a href="/practicumhub/home/managesubs">Manage Subscriptions</a></li>
      <li><a href="/practicumhub/home/managejobs">Manage Job Offer</a></li>
      <li><a href="/practicumhub/home/manageinterns">Manage Interns</a></li>
      <li class="divider"></li>
