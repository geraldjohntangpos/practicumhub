    ...
    <div class="col s12 m7">
      ...
      <?php
        ...
        if(count($myCompany)>0) {
          ?>
          <p>Company Name: <u><?php pr($myCompany[0]['company_name']); ?></u></p>
          <?php
        }
        else {
          ?>
          <p class="red-text"><u>Not belong to a company.</u>
            <a href="#" class="dropdown-button" data-activates='edit'>
              <i class="material-icons">mode_edit</i>
            </a>
          </p>
          <!-- Dropdown Structure -->
          <ul id='edit' class='dropdown-content black-text'>
            <li><a href="/practicumhub/home/addnewcomp">New</a></li>
          </ul>
          <?php
        }
        if($baseurl[1] == $_SESSION['ACCT_NO']){
