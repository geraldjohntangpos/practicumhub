...
<?php
  ...
  if($baseurl[1] == $_SESSION['ACCT_NO']) {
    $deptadminInfo = deptadminInfo(array($_SESSION['ACCT_NO']));
    if(count($deptadminInfo)>0) {
      foreach($deptadminInfo as $row) {
        $department_id = $row['department_id'];
      }
    }
    ?>
    <div class="fixed-action-btn" style="bottom: 45px; right: 24px;">
      <a class="btn-floating btn-large #9a8989" data-position="left" data-delay="50">
        <i class="large material-icons">menu</i>
      </a>
      <ul>
        <li>
          <a class="btn-floating #9a8989 tooltipped" data-position="left" data-delay="50" data-tooltip="Edit Profile" href="/practicumhub/home/updateprofile/<?php pr($_SESSION['ACCT_NO']); ?>">
            <i class="large material-icons">mode_edit</i>
          </a>
        </li>
        <li>
          <a class="btn-floating #9a8989 tooltipped" data-position="left" data-delay="50" data-tooltip="Manage School" href="/practicumhub/home/manageschool">
      ...
      <?php
        if($baseurl[1] == $_SESSION['ACCT_NO']){
          ...
          if(count($school)>0) {
            ...
            ?>
            <p>School: <u><a href="/practicumhub/home/manageschool"><?php pr($school_name); ?></a></u></p>
            <?php
          }
          else {
            ?>
            <p class="red-text">Not belong to a school yet.</p>
            <?php
          }
          ?>
